...
public class Main5Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setSupportActionBar(binding.appBarMain5.toolbar);
        binding.appBarMain5.fab.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder( //the 3 fragments to be display
